...
<template>
    ...
    <div class="bg-white">
            ...
            <nav class="flex items-center justify-center p-6 lg:px-8" aria-label="Global">
                ...
                <div class="flex mt-10">
                    <a href="#" class="-m-1.5 p-1.5">
                        ...
                        <img class="w-auto" src="/img/logo.png" alt="" />
                    </a>
                </div>
        ...
        <main>
            <!-- Hero section -->
            <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20 min-h-[100vh]">
                <img src="/img/4.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
                    ...
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div class="text-center">
                            <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                                Tender Information Sourcing Becomes Easier
                            </h1>
                            ...
                            <div class="mt-10 flex items-center justify-center gap-x-6">
                                ...
                                <Link :href="route('register')" class="text-xl font-semibold leading-6 text-white">Sign Up
